...
>(
    routeFunc: AddParameters<
        ...
        [
            ...
            session: Optional extends true ? string | null : string
        ]
    >,
    optional?: Optional
): CustomRouteHandlerMethod<T> {
    return async function(req, resp) {
        ...
        await routeFunc.call(this, req, resp, user, (req.cookies.sessionId || null) as Optional extends true ? string | null : string);
